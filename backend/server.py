...
def symbolic_ai_reply(user_text: str) -> str:
    ...
    rules = [
        (
            ...
            "Fases para resolver inicio de sesión:\n\n"
            "1) Verificaciones rápidas:\n"
            "- Escribe de nuevo tu email y contraseña (revisa mayúsculas/minúsculas y tildes).\n"
            "- Asegúrate de que Bloq Mayús no esté activo.\n"
            "- Elimina espacios antes/después al pegar.\n\n"
            "2) Si ves 'Credenciales inválidas':\n"
            "- Prueba con otra contraseña que suelas usar.\n"
            "- Si no recuerdas la contraseña, crea una cuenta nueva con tu email alternativo.\n\n"
            "3) Pruebas del navegador:\n"
            "- Refresca la página e intenta de nuevo.\n"
            "- Prueba en ventana incógnito o en otro navegador.\n\n"
            "4) Ayuda adicional:\n"
            "- Comparte el mensaje exacto del error para guiarte mejor."
        ),
        (
            "no puedo iniciar sesion",
            "Fases para resolver inicio de sesión:\n\n"
            "1) Verificaciones rápidas:\n"
            "- Escribe de nuevo tu email y contraseña (revisa mayúsculas/minúsculas).\n"
            "- Verifica Bloq Mayús y elimina espacios.\n\n"
            "2) Si ves 'Credenciales inválidas': prueba otra contraseña o registra una nueva cuenta.\n\n"
            "3) Navegador: recarga, usa incógnito u otro navegador.\n\n"
            "4) Envía el texto exacto del error para asistencia puntual."
        ),
        (
            "como vinculo mi cuenta",
            "Pasos para vincular tu cuenta (general):\n\n"
            "1) Abre la sección Cuenta o Ajustes > Vincular servicios.\n"
            "2) Elige Samsung/Salud y concede los permisos solicitados.\n"
            "3) Verifica que los permisos de actividad/pasos estén habilitados en tu teléfono.\n"
            "4) Vuelve a la app y force una sincronización (si hay botón) o espera unos minutos.\n\n"
            "Si no encuentras la opción, puede que aún no esté disponible en tu versión."
        ),
        (
            "¿cómo vinculo mi cuenta samsung?",
            "Pasos para vincular cuenta Samsung:\n\n"
            "1) Ajustes > Vincular servicios > Samsung.\n"
            "2) Inicia sesión en Samsung y acepta permisos.\n"
            "3) Habilita permisos de pasos/actividad en tu dispositivo.\n"
            "4) Regresa a la app y verifica la sincronización de pasos."
        ),
